...
import com.sudansh.deliveries.util.RecyclerViewAssertions.isNotEmpty
...
class MainActivityTest {
    ...
    @Test
    fun testItemClickOpensMap() {
        onView(withId(R.id.recyclerView))
                .perform(RecyclerViewActions.actionOnItemAtPosition<DeliverViewHolder>(0, click()))
